  ...
  <section class="my-10 my-container space-y-3">
      ...
      <div class="grid grid-cols-12 gap-3">
          <div class="col-span-12 md:col-span-8 space-y-4">
              ...
              <p class="text-md">
                  Learn from industry expert jose portilla and master essential skills
              </p>
                  ...
                  <ul class="space-y-2 text-sm">
                      <li>
                          <div class="flex gap-2">
                              <span class="tick my-auto"></span>Master the fundamental concepts and best practices
                          </div>
                      </li>
                      <li>
                          <div class="flex gap-2">
                              <span class="tick my-auto"></span>Build real - world projects for your portfolio
                          </div>
                      </li>
                      <li>
                          <div class="flex gap-2">
                              <span class="tick my-auto"></span>Gain practical skills used by industry professionals
                          </div>
                      </li>
                      <li>
                          <div class="flex gap-2">
                              <span class="tick my-auto"></span>Receive a certificate of completion
                          </div>
                      </li>
                      <li>
                          <div class="flex gap-2">
                              <span class="tick my-auto"></span>Access to exclusive community and resources
                          </div>
                      </li>
                  </ul>
          ...
          <div class="col-span-12 md:col-span-4">
              <div class="shadow-md border border-gray-200 p-4 rounded-3xl space-y-3">
                  ...
                  <ul class="space-y-2 text-sm">
                      <li>
                          <div class="flex gap-2">
                              <span class="play my-auto"></span>45 hrs on-demand video
                          </div>
                      </li>
                      <li>
                          <div class="flex gap-2">
