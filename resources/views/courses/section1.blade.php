...
<!--slider -->
 ...
 <section class="max-w-6xl mx-auto py-5">
    <h2 class="text-center text-xl font-semibold text-black">Partners with<span class="text-center text-xl font-semibold text-[#008357]"> Top Institutions</span>  to produce <span class="text-center text-xl font-semibold text-[#008357]">Best Quality Education</span></h2>
     <img src="./assets/courses/image 84 (1).png" class=" py-5" alt="parterns"/>
</section>

<!--end scetion-->
<section class="max-w-5xl mx-auto py-5">
    <h2 class="text-center text-black text-2xl font-semibold">Can’t Find What You’re Looking For ?</h2>
    <p class="text-center text-black text-sm font-normal py-3">we’re constantly adding new courses. Contact us with your suggestions!</p>
   <div class="flex justify-center pt-3">
    <button type="button" class="text-center text-white text-lg rounded-3xl py-2 px-10 bg-[#008357] ">GET IN TOUCH</button>
   </div>
</section>
