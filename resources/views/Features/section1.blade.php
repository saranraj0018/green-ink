     ...
     <section class="my-container my-5 md:my-10 py-5 md:py-10 bg-[#fafafa] space-y-3">
     ...
     <section class="max-w-6xl mx-auto py-5">
         <div class="py-10 px-5 rounded-3xl bg-gray-100">
             <h2 class="text-center text-2xl font-semibold text-black ">Ready to Experience These Features?</h2>
             <p class="text-center text-sm font-normal text-black py-3">Join Green Link Academy today and start your
                 journey toward success</p>
             <div class="flex justify-center">
                 <a href="/courses"
                     class="text-lg text-white text-center font-semibold py-2 px-8 mt-5 rounded-3xl bg-gradient-to-b from-[#008357] to-[#2BCD97] ">Get
                     Started Now</a>
             </div>
         </div>
     </section>
