 ...
 <section class="max-w-6xl mx-auto py-10">
    <div class="grid grid-cols-12 gap-5">
        <div class="col-span-12 md:col-span-3 bg-gradient-to-b from-[#1B4D3E] to-[#009C6D] rounded-3xl pt-8 pb-10 px-5">
          ...
          <h2 class="text-white text-lg font-semibold pt-5">Interactive Learning</h2>
         ...
         <div class="col-span-12 md:col-span-3 bg-gradient-to-b from-[#1B4D3E] to-[#009C6D] rounded-3xl pt-8 pb-10 px-5">
          ...
          <h2 class="text-white text-lg font-semibold pt-5">Experts Mentors</h2>
          <p class="text-white text-sm text-justify pt-4 ">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.  </p>
        </div>
          <div class="col-span-12 md:col-span-3 bg-gradient-to-b from-[#1B4D3E] to-[#009C6D] rounded-3xl pt-8 pb-10 px-5">
          <img src="./assets/Features/icon2.png" class="" alt="icon"/>
          <h2 class="text-white text-lg font-semibold pt-5">Certified Programs</h2>
          <p class="text-white text-sm text-justify pt-4 ">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.  </p>
        </div>
          <div class="col-span-12 md:col-span-3 bg-gradient-to-b from-[#1B4D3E] to-[#009C6D] rounded-3xl pt-8 pb-10 px-5">
          <img src="./assets/Features/icon3.png" class="" alt="icon"/>
          <h2 class="text-white text-lg font-semibold pt-5">Flexible Schedule</h2>
          <p class="text-white text-sm text-justify pt-4 ">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.  </p>
        </div>
  ...
  <section class="max-w-6xl mx-auto py-3">
    <div class="grid grid-cols-12 gap-20">
      ...
      <p class="text-black text-sm font-normal pt-3">High-Quality video content with subtitles</p>
            ...
            <img src="./assets/features/circle.png" class="w-3 h-3 mt-4" alt="" />
      <p class="text-black text-sm font-normal pt-3">Interactive coding environment and projects</p>
           </div>
           <div class="flex gap-3 pt-2">
            <img src="./assets/features/circle.png" class="w-3 h-3 mt-4" alt="" />
      <p class="text-black text-sm font-normal pt-3">Downloadable resources and reference materials</p>
           </div>
        </div>
        <div class="col-span-12 md:col-span-6">
...
<!-- -->
    <div class="grid grid-cols-12 gap-20 pt-3">
          <div class="col-span-12 md:col-span-6">
      ...
      <p class="text-black text-sm font-normal pt-3">Industry-recognized certification</p>
            ...
            <div class="flex gap-3 pt-2">
            <img src="./assets/features/circle.png" class="w-3 h-3 mt-4" alt="" />
      <p class="text-black text-sm font-normal pt-3">Shareable on linkedin and social media</p>
           </div>
           <div class="flex gap-3 pt-2">
            <img src="./assets/features/circle.png" class="w-3 h-3 mt-4" alt="" />
      <p class="text-black text-sm font-normal pt-3">Lifetime access to your certification</p>
           </div>
        </div>
    </div>
  </section>
