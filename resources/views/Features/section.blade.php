 ...
 <section class="my-container py-3">
     <div class="grid grid-cols-12 gap-2 md:gap-20">
         <div class="col-span-12 md:col-span-6">
             <h2 class="text-2xl text-black font-semibold">Live Class System (1 Hour 30 Minutes)
             </h2>
             <p class="text-sm text-justify font-medium text-[#1B4D3E] pt-3">Each live class follows a complete learning
                 cycle: Previous Class Revision & Quiz – recall key concepts and identify gaps.
             </p>

             <div class="flex gap-3 pt-1">
                 <img src="/assets/features/circle.png" class="w-3 h-3 mt-4" alt="" />
                 <p class="text-black text-sm font-normal pt-3">In-depth Topic Teaching – Concepts explained from basics
                     to exam level </p>
             </div>
             <div class="flex gap-3 pt-1">
                 <img src="/assets/features/circle.png" class="w-3 h-3 mt-4" alt="" />
                 <p class="text-black text-sm font-normal pt-3">Quick Class Revision – Reinforce learning before closure
                 </p>
             </div>
             <div class="flex gap-3 pt-1">
                 <img src="/assets/features/circle.png" class="w-3 h-3 mt-4" alt="" />
                 <p class="text-black text-sm font-normal pt-3">PYQ Discussion – Connect concepts with real exam
                     questions</p>
             </div>
         </div>
         <div class="col-span-12 md:col-span-6">
             <img src="/assets/features/Group 603.png" class="" alt="pic" />
         </div>
     </div>

     <!-- -->
     <div class="grid grid-cols-12 gap-2 md:gap-20 pt-3">
         <div class="col-span-12 md:col-span-6">
             <img src="/assets/features/Group 604.png" class="" alt="pic" />
         </div>
         <div class="col-span-12 md:col-span-6">
             <h2 class="text-2xl text-black font-semibold pt-5">Our Test & Discussion System
             </h2>
             <p class="text-sm text-justify font-medium text-[#1B4D3E] pt-3">Every test at GreenInk is followed by
                 focused discussion, helping you:
             </p>

             <div class="flex gap-3 pt-2">
                 <img src="/assets/features/circle.png" class="w-3 h-3 mt-4" alt="" />
                 <p class="text-black text-sm font-normal pt-3">Understand why answers are right or wrong</p>
             </div>
             <div class="flex gap-3 pt-2">
                 <img src="/assets/features/circle.png" class="w-3 h-3 mt-4" alt="" />
                 <p class="text-black text-sm font-normal pt-3">See how others think and approach questions</p>
             </div>
             <div class="flex gap-3 pt-2">
                 <img src="/assets/features/circle.png" class="w-3 h-3 mt-4" alt="" />
                 <p class="text-black text-sm font-normal pt-3">Pinpoint your exact weak areas</p>
             </div>
             <div class="flex gap-3 pt-2">
                 <img src="/assets/features/circle.png" class="w-3 h-3 mt-4" alt="" />
                 <p class="text-black text-sm font-normal pt-3">Fix mistakes with the right exam mindset
                 </p>
             </div>
             <p class="text-sm text-justify font-medium text-[#1B4D3E] pt-3">Most students don't fail due to lack of
                 effort but due to unnoticed gaps. Our discussions make sure those gaps are corrected, not repeated.
