 ...
 <section class="my-container my-10 space-y-3">
     ...
     <div class="grid grid-cols-12 gap-3">
         <div class="col-span-12 md:col-span-4 border border-gray-200 rounded-2xl p-3 space-y-2">
             <img src={{ asset('assets/about/profile.png') }} alt="" class="mx-auto w-1/4">
             <div class="mx-auto w-max bg-[#FFD77B] flex gap-1 rounded-full py-0.5 px-2">
                 <span class="starIcon my-auto"></span>
                 4.9
             </div>
             ...
             <div class="flex flex-wrap gap-2 justify-center">
                 <div
                     class="border-l border-t border-b border-primary-light rounded-full px-3 py-1 text-[13px] text-primary-light">
                     Web Development
                 </div>
                 <div
                     class="border-l border-t border-b border-primary-light rounded-full px-3 py-1 text-[13px] text-primary-light">
             ...
             <div class="flex justify-between">
                 <div class="mx-auto">
                     <span class="user flex justify-center"></span>
                     <div class="text-[#BE8400]">
                         25,000+ Students
                     </div>
                 </div>
                 <div class="mx-auto">
                     <span class="courses flex justify-center"></span>
                     <div class="text-[#BE8400]">
                         8+ Courses
                     </div>
                 </div>
 ...
 <script>
   ...
   <svg xmlns="http://www.w3.org/2000/svg" width="24" height="17" viewBox="0 0 24 17" fill="none">
    ...
    `;
         const courses = `
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="20" viewBox="0 0 30 30" fill="none">
