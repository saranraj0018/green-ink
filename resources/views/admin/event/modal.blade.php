<div id="eventModal" x-data="{
    ...
    <!-- Modal -->
    <div
        class="bg-white p-8 rounded-2xl shadow-2xl w-[700px] max-w-[95%] relative z-10
        ...
        <form id="eventForm" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 items-end">
                ...
                <div>
                    <label class="font-medium">Event Fee</label>
                    <div class="flex gap-6 mt-3">
                        <label class="flex gap-2">
                            <input type="radio" name="fee_type" value="free" x-model="form.fee_type">
                            Free
                        </label>

                        <label class="flex gap-2">
                            <input type="radio" name="fee_type" value="paid" x-model="form.fee_type">
                            Paid
                        </label>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <input type="number" name="amount" x-model="form.amount" placeholder="Enter amount"
                        :readonly="form.fee_type === 'free'"
                        :class="form.fee_type === 'free' ?
            ...
            <div class="flex justify-end gap-3 pt-4">
                <button type="button" onclick="$('#eventModal').hide()"
        ...
        <div class="fixed inset-0 flex items-center justify-center z-50">
            ...
            <div class="bg-white p-6 rounded-xl shadow-xl w-[400px] relative z-10">
                ...
                <div class="flex justify-end gap-3">
                    <button @click="open = false" class="px-4 py-1 border rounded-lg hover:bg-gray-100">
                        Cancel
                    </button>
