<x-layouts.auth>
    <div class="w-full max-w-5xl bg-white rounded-3xl shadow-lg overflow-hidden flex border">
        ...
        {{-- Left Side (Image) --}}
       <div class="hidden md:flex w-1/2 bg-white items-center justify-center overflow-hidden rounded-l-3xl">

    <img
        src="{{ asset('GIA Horizontal.jpg') }}"
        alt="Greenink"
        class="object-contain w-[80%] h-auto" />
        ...
        <div class="w-full md:w-1/2 p-10 flex flex-col justify-center">
            ...
            <h2 class="text-2xl font-bold text-[#006400] mb-2">Welcome Back</h2>
            <p class="text-sm text-gray-500 mb-6">Sign in to your Greenink dashboard</p>
                ...
                <div>
                    ...
                    <div class="relative">
                        <input :type="show ? 'text' : 'password'" name="password"
                            class="w-full border border-gray-300 rounded-md px-3 py-2 mt-1
                              focus:outline-none focus:ring-2 focus:ring-[#006400] pr-10"
                            placeholder="••••••••" />
            ...
            <p class="text-sm text-center text-gray-600 mt-6">
                ...
                <a href="{{ route('admin.register') }}" class="text-[#006400] font-medium hover:underline">
                    Sign Up
                </a>
            </p>
        </div>
