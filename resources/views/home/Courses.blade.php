                ...
                <div class="bg-white rounded-2xl shadow-md hover:shadow-xl transition-all border border-gray-200">
                    ...
                    <div class="p-4">
                        ...
                        <div class="flex gap-2 text-sm text-gray-700 mt-2">
                            <p class="flex gap-1 font-medium text-primary-light"> <span class="studentsGroup"></span> {{ $course['students'] }}</p>
                            <p class="flex gap-1 font-medium text-primary-light"> <span class="duration"></span> {{ $course['duration'] }}</p>
                        </div>
